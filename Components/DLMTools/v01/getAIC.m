function [AIC] = getAIC(griddata,kr,AeroType)
...
n_hat_w = griddata.nhatPF;
n_hat_wl = griddata.nhatWL;
...
%% Obtain AIC matrix
if AeroType == 'VLM'
    [~,AIC] = getVLM(P0,P1,P3,PanelArea,PanelSpan,n_hat_w,n_hat_wl);
elseif AeroType == 'DLM'
    Dv = getVLM(P0,P1,P3,PanelArea,PanelSpan,n_hat_w,n_hat_wl);
