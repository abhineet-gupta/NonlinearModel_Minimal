...
xbody_top = -y_m(1:l1)*(1.74);      % xcoord of the LE of body
xbody_bot = y_m(1:l1)*tan(22*pi/180) - c_root; % xcoord of TE of body
xbody = [xbody_top;xbody_bot];  % xcoord of LE+TE of body


%% wings coordinates
% xcord of LE between kink1 and 2
xwing_top_1 = -(y_m(l1+1:l2)-y_m(l1+1))*tan(22*pi/180) + xbody_top(l1);

% xcord of LE between kink2 and wingtip
xwing_top_2 = -(y_m(l2+1:end)-y_m(l2+1))*1.73 + xwing_top_1(end);

% xcord of TE between kink1 and kink in TE
xwing_bot_1 = (y_m(l1+1:l3)-y_m(l1+1))*tan(22*pi/180) + xbody_bot(l1);

% xcord of TE between kink in TE and wingtip
xwing_bot_2 = -(y_m(l3+1:end)-y_m(l3+1))*tan(22*pi/180) + xwing_bot_1(end);
